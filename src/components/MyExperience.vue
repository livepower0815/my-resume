      ...
      <div class="row d-flex justify-content-center py-4">
        <div class="col-md-3 justify-content-md-end d-none d-md-flex">
          <div class="position-relative exInner">
            <img class="img-fluid exImg" src="../assets/experience/iconfinder_Notebook_by_Artdesigner_60879.png"
              alt="img">
        ...
        <div class="col-md-8">
          <div class="exContent text-white">
            ...
            <p>在任職期間研究並開始使用 React 框架，因為有個重大遷移專案，必須熟悉 React 及 Vue 兩者的架構才能做到最相容的轉換，UI 元件的客製化及 jsx
              的使用上得到了飛躍式的進步，並且在12月底完成遷移並測試完成。可惜在1月初陸方資金發生了一些問題，遺憾的無緣與台灣同事再繼續共事。</p>
          </div>
        </div>
      </div>
      <!-- thinkpower -->
