...
2017 年開始為自己定了前端的職涯方向，這段期間由於家庭因素的關係只能利用下班時間去做線上學習。
2018 年底時已能獨立架設 Vue.js & Node.js 商業的金流網頁。
2019 正式踏入前端工作，並也開始研究使用 React 框架，目前主要參與過兩個大型專案如下。
1. Vue 架構的 CRM (客戶關係管理)
2. React 彩票網架構重構成 Vue 架構
...
### UI 框架
* **Bootstrap**、**AntD**、**Semantic UI**、**Element-UI**

### 後端
* **Node.js** - npm 工具使用、Express.js 架設 Web 應用
* **Postman** -  API 測試
* **Webpack** - 轉換 ES6、CSS預處理(less、sass) 檔案打包網站

### DataBase
* **Firebase** - 主要使用 `admin`、`database`、`hosting` 模組
* **MongoDB** - Robo 3T 操作並配合使用 `mongoose` library

### 其他
* **Git** - 進行團隊協作、sourcetree 操作、Github 部署、Heroku 部署
...
1. **CRM Web App 客戶關係管理網頁平台** (版權問題無法提供 Demo)
    ...
    * Vuex 管理全域 User & Customer info 資料，使 component 能更靈活的取得父級資訊
